    ...
    public boolean deleteFile(String imgUrl) {
      //  if(imgUrl == null) return true;
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"AwsService side exception");
        }catch (SdkClientException e){
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"AwsClient side exception");
        }
    }
}
